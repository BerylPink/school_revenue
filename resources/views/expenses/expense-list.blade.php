      ...
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="page-title">
            <h5>Expense List</h5>
            <h6 class="sub-heading">All Expenses as of <strong><?php echo date('M, d Y'); ?></h6>
          </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <div class="right-actions">
            <a href="{{ route('expenses.create') }}" class="btn btn-primary float-right" data-toggle="tooltip" data-placement="left" title="Add Expense">
                <i class="icon-plus"></i>
              </a>
            </div>
          </div>
        ...
        <table id="basicExample" class="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php $date = \Carbon\Carbon::parse($expense->created_at , 'UTC'); echo $date->isoFormat('MMMM Do YYYY h:mm:ssa'); ?></td>
              <td>
              <div class="dropdown text-center">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 38px, 0px); top: 0px; left: 0px; will-change: transform;">
                      ...
                      <form method="POST" action="{{ route('expenses.destroy', ['expenses' => $expense->id]) }}">
                        @csrf @method('DELETE')
                        <button type="submit" class="dropdown-item" href=""   title="Delete {{ $expense->expense_name }}">
