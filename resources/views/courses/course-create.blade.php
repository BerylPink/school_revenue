    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row gutters">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="course_code" placeholder="" class="form-control @error('course_code') is-invalid @enderror" name="course_code" value="{{ old('course_code') }}" required autocomplete="course_code" autofocus>
            @error('course_code')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
