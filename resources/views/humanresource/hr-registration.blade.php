...
@section('title', 'Human Resources Registration')
@section('content')
      ...
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="page-title">
            <h5>Human Resources Registration</h5>
            <h6 class="sub-heading">Create a new Human Resources Profile</h6>
          </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <div class="right-actions">
              <a href="{{ route('human-resource.index') }}" class="btn btn-success float-right" data-toggle="tooltip" data-placement="left" title="Human resource list">
    ...
    <!-- Row start -->
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('human-resource.store') }}" enctype="multipart/form-data">
                    @csrf
                <div class="form-row">
