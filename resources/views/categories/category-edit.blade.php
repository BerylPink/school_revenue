    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row gutters">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="category_name" placeholder="Name" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{ old('category_name') ?? $category->category_name }}" required autocomplete="category_name" autofocus>
            @error('category_name')
