...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Super Admin') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('viewsonly.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" maxlength="11" type="tel" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" value="{{ old('phone_no') }}" required autocomplete="phone_no" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="profile_avatar" class="col-md-4 col-form-label text-md-right">{{ __('Avatar') }}</label>
                            <div class="col-md-6">
                                <input type="file" accept="image/x-png,image/gif,image/jpeg" id="profile_avatar" name="profile_avatar" class="form-control-file">
                            </div>
                        </div>
                        <div class="form-group row">
