...
@section('title', 'Academic Staff Payment List')
@section('content')
      ...
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="page-title">
            <h5>Academic Staff Payment List</h5>
            <h6 class="sub-heading">All Academic Staff payments made as of <strong><?php echo date('M, d Y'); ?></h6>
          </div>
        </div>
      </div>
    </div>
