      ...
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="page-title">
            <h5>Academic Payment Details</h5>
          <h6 class="sub-heading" {{ $academicPayment->firstname.' '.$academicPayment->lastname }}</h6>
          </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <div class="right-actions">
            <a href="{{ route('payments.academic_list') }}" class="btn btn-success float-right" data-toggle="tooltip" data-placement="left" title="Academic Payments List">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row gutters">
          <label for="expense_name" class="col-sm-3 col-form-label">Academic Staff Name</label>
          <div class="col-sm-9">
      ...
      <div class="form-group row gutters">
        ...
        <div class="form-group row gutters">
          <div class="col-sm-10">
            <a href="{{ route('payments.academic_list') }}" class="btn btn-danger">Back</a>
          </div>
        </div>
        </form>
      </div>
